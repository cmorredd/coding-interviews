 ...
 *  Be prepare for cross questions like using iteration over recursion and how to optimize the solution using caching and memorization.
 *
 */
...
public class FibonacciSeriesExample {
	...
	/** Java program for Fibonacci number using Iterative. 
	 *  This program uses tail iterative logic to calculate Fibonacci number for a given number 
	 *   @return Fibonacci number
	 **/ 
